...
const settings = ref<LeaderboardSettings>({ enabled: false, title: 'Token 排行', period: 'week', metric: 'tokens', limit: 20, minimum_tokens: 0, minimum_requests: 0, include_user_ids: [], exclude_user_ids: [], show_platform_breakdown: true })
